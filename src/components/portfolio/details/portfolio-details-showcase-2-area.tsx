            ...
            <div className="row">
                ...
                <div className="col-xl-9">
                  <div className="showcase-details-2-section-right tp_title_anim">
                      <p>Studio Gria web sitesi genel bir şablon kullanıyordu ve çalışmalarının kalitesiyle uyumlu değildi. Amaç; yüksek nitelikli fotoğrafçılığı, modern ve akılda kalıcı bir dijital deneyime dönüştürmekti.</p>
                  </div>
                </div>
            </div>
          </div>
            ...
            <div className="row">
                ...
                <div className="col-xl-9">
                  <div className="showcase-details-2-content-right tp_title_anim">
                      <p className="pb-25">Studio Gria web sitesi genel bir şablon kullanıyordu ve çalışmalarının kalitesiyle uyumlu değildi. Ana hedef, yüksek kaliteli fotoğrafçılığı saygın ve modern bir dijital deneyime dönüştürmekti.</p>
                      <p>Her vaka çalışması, özel içerik yönetim sistemindeki stil seçenekleriyle kendi kimliğini kazanır. Bu seçenekler, sitenin her kompozisyonda harika görünmesini sağlamak için önceden tanımlanmıştır.</p>
                  </div>
                </div>
            </div>
          </div>
