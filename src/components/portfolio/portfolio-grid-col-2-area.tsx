      ...
      <div className="container container-1530">
        ...
        <div className="row grid" ref={isotopContainer}>
          {portfolio_data.map((item) => (
            ...
            >
              <div className="tp-project-5-2-thumb anim-zoomin-wrap mb-30 not-hide-cursor p-relative" data-cursor="Incele">
                <Link href={`/portfolio/${item.title.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "")}`} className="cursor-hide">
                  <Image
