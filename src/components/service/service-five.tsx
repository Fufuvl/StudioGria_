...
const service_data = [
  {
    id: 1,
    title: "Branding",
    desc: "Marka kimliği, bir işletmenin dijitalde güçlü bir duruş sergilemesi için en önemli yapıtaşlarından biridir. Studio Gria olarak, markanızı rakiplerinizden ayıran özgün bir görsel dil ve stratejik iletişim altyapısı oluşturuyoruz.",
    icon: s_2,
  },
  {
    id: 2,
    title: "İçerik Üretimi",
    desc: "Hedef kitlenize hitap eden özgün içerikler üreterek sosyal medya hesaplarınızı daha etkili hale getiriyoruz.",
    icon: s_1,
  },
  {
    id: 3,
    title: "Sosyal Medya Yönetimi",
    desc: "Sosyal medya kampanyalarınızla marka bilinirliğinizi artırıyor, takipçi etkileşimini sürdürülebilir hale getiriyoruz.",
    icon: s_3,
  },
];
